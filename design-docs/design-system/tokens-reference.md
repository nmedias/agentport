...
- { token: primary-fill,   css_var: --ap-sys-primary-fill,   primitive: deep/900,   value: "#0d2531", utilities: [bg-primary-fill, border-primary-fill],  scopes: [FRAME_FILL, SHAPE_FILL, STROKE_COLOR], use: "Primary surface of the main action. Also the edge of that same area, so fill and edge read as one form. Pairs with primary-ink." }
