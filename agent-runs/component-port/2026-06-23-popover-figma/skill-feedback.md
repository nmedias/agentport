...
| Status | open — A5 already tracked; this run = confirming evidence + the resize-the-section addendum. |
...
| Related | Sister of C2/C3 (all /figma-verify heuristic/scope gaps). |
| Status | open — C7 already tracked; this run = confirming evidence. |
...
| Related | Sister of C2/C3/C7 (/figma-verify heuristic refinements); echoes C3 (designated-overlap allowlist). |
| Status | open (tooling). |
...
| Status | open — skill edit pending. |
...
| Status | deferred — supersedes/corrects B33. |
