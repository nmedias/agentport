...
// ⚠ `secondary` + `destructive` bind to the stock placeholder tokens
// (--secondary/--destructive are raw hex, status:placeholder in tokens-reference
// §1) — NOT finalized DS colours; flagged, kept structurally faithful.
// `ghost`/`link` are Nova-baseline extras (denser source than the stock doc's
// 4 variants); kept on DS tokens (muted hover / primary link). dark: dropped.
