...
const meta: Meta<typeof Tooltip> = {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component:
          'A hover/focus hint chip with a pointer arrow, delayed by the shared provider. It describes its trigger, it does not name it — an icon-only trigger still needs its own label.',
      },
    },
  },
};
