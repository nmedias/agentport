...
//  keyboard-key format) · gap-1/px-1 (4px) → gap-xs/px-xs · bg-muted +
//  text-muted-foreground kept (quiet chrome surface + secondary glyph) ·
...
function Kbd({ className, ...props }: React.ComponentProps<'kbd'>) {
  return (
    <kbd
      data-slot="kbd"
      className={cn(
        'pointer-events-none inline-flex h-5 w-fit min-w-5 items-center justify-center gap-xs rounded-sm bg-muted px-xs text-kbd text-muted-foreground select-none',
